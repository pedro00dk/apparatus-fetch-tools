    ...
    [Path in keyof Paths]: {
        [Method in keyof Paths[Path] as Method extends Methods ? Method : never]: OptionalUndefined<{
            path: H.Call<
                ...
                [
                    ...Default<Get<Paths[Path], 'parameters'>, Array<unknown>, []>,
                    ...Default<Get<Paths[Path][Method], 'parameters'>, Array<unknown>, []>,
                ]
            >
            header: H.Call<
